...
ActiveRecord::Schema.define(version: 20_171_203_160_522) do
  ...
  create_table 'boxes', force: :cascade do |t|
    ...
    t.text 'owner_name'
    t.index %w[home_team_id away_team_id sheet_id], name: 'index_boxes_on_home_team_id_and_away_team_id_and_sheet_id', unique: true
  ...
  create_table 'sheets', force: :cascade do |t|
    ...
    t.index %w[user_id game_id name], name: 'index_sheets_on_user_id_and_game_id_and_name', unique: true
  end
