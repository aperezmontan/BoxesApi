...
describe 'Sheets', :type => :request do
  ...
  describe 'post /sheets' do
    ...
    subject { post '/sheets', :params => { :sheet => sheet_params } }
    ...
    context 'with bad params' do
      context 'without unpermitted params' do
        it 'ignores unpermitted params' do
          post '/sheets', :params => { :sheet => sheet_params.merge!(:foo => 'bar') }
      ...
      xcontext 'without a user' do
        xit 'responds with an error' do
          post '/sheets', :params => { :sheet => bad_sheet_params.merge!(:game_id => Game.first.id) }
      ...
      context 'without a game' do
        it 'responds with an error' do
          post '/sheets', :params => { :sheet => bad_sheet_params.merge!(:user_id => User.first.id) }
